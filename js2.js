...
document.getElementById("page1Btn").addEventListener("click", function() {
    document.getElementById("content").innerHTML = `
      <h2>Halaman Utama</h2>
      <p>Klik <a href="html.html"> disisni </a>untuk mengetahui informasi lebih lanjut</p>
      `;
  });
  ...
  // Contoh: Mengambil referensi ke video dan tombol play/pause
const video = document.querySelector('video');
const playButton = document.getElementById('play-button');

// Memberikan fungsi untuk tombol play/pause
